...
alias mp4small_neg='shopt -s globstar; for f in **/*.mp4 ; do nice -n 19 ffmpeg -i "$f" -c:v libx265 -crf 40 -preset fast -vf "fps=5,negate" -c:a aac -b:a 64k "${f%.*}_small.mp4"; done'
